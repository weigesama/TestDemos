...
public class PaginationTest {
    ...
    public void tests() {
        ...
        System.err.println("当前页数 ------> " + userIPage.getCurrent());
        System.err.println("当前每页显示数 ------> " + userIPage.getSize());
        print(userIPage.getRecords());
        System.err.println("----- baseMapper 自带分页 ------");

        System.err.println("json 正反序列化 begin");
        ...
        System.err.println("json 正反序列化 end");
        ...
        System.err.println("总条数 ------> " + userMyPage.getTotal());
        System.err.println("当前页数 ------> " + userMyPage.getCurrent());
        System.err.println("当前每页显示数 ------> " + userMyPage.getSize());
